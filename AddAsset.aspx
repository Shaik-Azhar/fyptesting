<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddAsset.aspx.cs" Inherits="Asset_Tracking_System.AddAsset" %>
...
<body>
    <script type="text/javascript">
        ...
        function Save()
        {
            ...
            xmlhttp.open('POST', 'ajaxPerformAddAsset.aspx', true)
                ...
                <table width="100%">
                    <tr>
                        <td width="20%">
                            ...
                            <br />
                            <br />
                            <input type="button" value="Cancel" style="width:150px" onclick="location.href='ManageAsset.aspx'" />
                        </td>
                ...
                <table width="50%" class="auto-style1">
                    ...
                    <tr>
                        ...
                        <td><select id="room" style="width:100%" required="required">
                            <%=Asset_Tracking_System.AddAsset.GenerateRoomOptions()%>
                            </select></td>
                                </div>
                            </div>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td><select id="vendor" style="width:100%" required="required">
                            <%=Asset_Tracking_System.AddAsset.GenerateVendorOptions()%>
                            </select></td>
                                 </div>
                            </div>
                    </tr>
                    ...
                    <div class =" input_field">
                     <td>Asset Type:</td>
                        ...
                        <td><select id="holder" style="width:100%" required="required">
                            <%=Asset_Tracking_System.AddAsset.GenerateHolderOptions()%>
                            </select></td>
                                 </div>
                            </div>
